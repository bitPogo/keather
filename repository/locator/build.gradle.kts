...
val projectPackage = "io.bitpogo.keather.repository.locator"
...
kotlin {
    ...
    iosx {
        ...
        val libraryPath = "$rootDir/repository/locator/$libraryName/build/Build/Products/Release-$platform"
        val frameworksPath = libraryPath

        compilations.getByName("main") {
            cinterops.create("Locator") {
                val interopTask = tasks[interopProcessingTaskName]
                interopTask.dependsOn(":repository:locator:Locator:build${platform.capitalize()}")
