...
internal class AppleLocatorContractProtocolMock(
  ...
  public val _locateWithCallback:
      ...
      ProxyFactory.createSyncFunProxy("io.bitpogo.keather.locator.AppleLocatorContractProtocolMock#_locateWithCallback",
      collector = collector, freeze = freeze)

  public override
      fun locateWithCallback(callback: Function1<LocationResultContractProtocol?, Unit>): Unit =
