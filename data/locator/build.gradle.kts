...
kotlin {
    ...
    iosx {
        ...
        val libraryPath = "$rootDir/data/locator/$libraryName/build/Build/Products/Release-$platform"
        val frameworksPath = libraryPath

        compilations.getByName("main") {
            cinterops.create("Locator") {
                val interopTask = tasks[interopProcessingTaskName]
                interopTask.dependsOn(":data:locator:Locator:build${platform.capitalize()}")
